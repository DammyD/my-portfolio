/**
 * FallingPattern — from 21st.dev
 * Adapted for plain React (no Tailwind required).
 * Original: https://21st.dev — FallingPattern component
 *
 * Props:
 *   color           — primary color of falling lines  (default: 'var(--accent)')
 *   backgroundColor — background fill                 (default: '#09090f')
 *   duration        — animation duration in seconds   (default: 150)
 *   blurIntensity   — backdrop blur amount            (default: '1em')
 *   density         — dot pattern spacing multiplier  (default: 1)
 */
